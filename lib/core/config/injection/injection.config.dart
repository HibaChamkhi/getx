...
import 'package:getx_project/core/config/injection/data_source_injection.dart'
    as _i10;
import 'package:getx_project/core/config/router/app_router.dart' as _i3;
import 'package:getx_project/data/dataSources/remote/user_data_source.dart'
    as _i6;
import 'package:getx_project/data/repositories/user_repository_impl.dart'
    as _i8;
import 'package:getx_project/domain/repositories/user_repository.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i6.UserDataSource>(
        () => dataSourceInjectableModule.getUserDataSource(gh<_i5.Dio>()));
